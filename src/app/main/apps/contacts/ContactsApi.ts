  ...
  .injectEndpoints({
    endpoints: (build) => ({
      getContactsList: build.query<
        GetContactsListApiResponse,
        GetContactsListApiArg
      >({
        query: () => ({ url: `/mock-api/contacts` }),
        providesTags: ["contacts"],
      }),
      createContactsItem: build.mutation<
        CreateContactsItemApiResponse,
        CreateContactsItemApiArg
      >({
        query: (queryArg) => ({
      ...
      deleteContactsItem: build.mutation<
        DeleteContactsItemApiResponse,
        DeleteContactsItemApiArg
      >({
        query: (contactId) => ({
      ...
      deleteContactsTag: build.mutation<
        DeleteContactsTagApiResponse,
        DeleteContactsTagApiArg
      >({
        query: (tagId) => ({
...
export type UpdateContactsItemApiResponse =
  /** status 200 Contact Updated */ Contact;
